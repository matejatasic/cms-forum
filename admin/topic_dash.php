        ...
        <div class="card-body">
            <?php
                if($total_rows > 0) {
                    ...
                    echo '
                        <table class="table table-hover topic-requests">
                            <thead>
                                <tr>
                                    <th>Topic Title</th>
                                    <th>Topic Author</th>
        ...
        $('.accept').click((e) => {
            ...
            $.ajax({
                ...
                error: (xhr, ajaxOptions, thrownError) => {
                    ...
                    message.html('<div class="alert alert-danger">There was an error while trying to confirm the topic...</div>');
                },
            });
        });
        ...
        $('.reject').click((e) => {
            ...
            $.ajax({
                ...
                error: (xhr, ajaxOptions, thrownError) => {
                    console.log(xhr.status);
                    console.log(thrownError);
                    message.html('<div class="alert alert-danger">There was an error while trying to reject the topic...</div>');
                },
            });
        });
    });
